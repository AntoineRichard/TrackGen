...
| | | docs |
|---|---|---|
| **Six track generators** | Bezier, checkpoint-steering, hull, polar, Voronoi, and repulsive-growth (a self-repulsive serpentine option — the slowest, an iterative optimizer, but graph-captured like the rest) — one config, per-env styles | [Generators](https://antoinerichard.github.io/TrackGen/generators/overview.html) |
