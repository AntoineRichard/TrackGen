# Duplicate full-text screening codebook v2
...
| Value | Normative meaning |
| --- | --- |
| `include-1` | Directly synthesizes, samples, selects, mutates, repairs, validates, optimizes, or serializes course geometry or a course distribution for racing robots or a transferable adjacent domain. |
| `include-2` | Makes a source-native contribution that defines a representation, design interface, simulator interface, dataset, benchmark, competition course set, or interchange artifact specifically for generated or parameterized courses. |
...
or parameterized courses satisfies `include-2`.
